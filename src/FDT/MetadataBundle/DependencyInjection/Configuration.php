                        ...
                        ->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->addDefaultsIfNotSet()
                                    ...
                                    ->children()
                                        ->scalarNode('valueDocument')
                                            ->defaultValue('FDT\\MetadataBundle\\Document\\Attributi\\Value\\TextValue')
                                        ->end()
                                    ->end()
                                ->end()
                                ...
                                ->addDefaultsIfNotSet()
                                    ...
                                    ->children()
                                        ->scalarNode('valueDocument')
                                            ->defaultValue('FDT\\MetadataBundle\\Document\\Attributi\\Value\\HashValue')
                                        ->end()
                                    ->end()
                                ->end()
                                ->arrayNode('textarea')
                                ...
                                ->addDefaultsIfNotSet()
                                    ...
                                    ->children()
                                        ->scalarNode('valueDocument')
                                            ->defaultValue('FDT\\MetadataBundle\\Document\\Attributi\\Value\\IntValue')
                                        ->end()
                                    ->end()
                                ->end()
                                ->arrayNode('decimal')
                                ->addDefaultsIfNotSet()
                                    ...
                                    ->children()
                                        ->scalarNode('valueDocument')
                                            ->defaultValue('FDT\\MetadataBundle\\Document\\Attributi\\Value\\FloatValue')
                                        ->end()
                                    ->end()
                                ->end()
                                ->arrayNode('boolean')
                                ->addDefaultsIfNotSet()
                                    ...
                                    ->children()
                                        ->scalarNode('valueDocument')
                                            ->defaultValue('FDT\\MetadataBundle\\Document\\Attributi\\Value\\BooleanValue')
                                        ->end()
                                    ->end()
                                ->end()
                                ->arrayNode('data')
                                ->addDefaultsIfNotSet()
                                    ...
                                    ->children()
                                        ->scalarNode('valueDocument')
                                            ->defaultValue('FDT\\MetadataBundle\\Document\\Attributi\\Value\\DataValue')
                                        ->end()
                                    ->end()
                                ->end()
                                ->arrayNode('email')
                                ...
                                ->addDefaultsIfNotSet()
                                    ...
                                    ->children()
                                        ->scalarNode('valueDocument')
                                            ->defaultValue('FDT\\MetadataBundle\\Document\\Attributi\\Value\\FileValue')
                                        ->end()
                                    ->end()
                                ->end()
                                ->arrayNode('documento')
                                ...
                                ->addDefaultsIfNotSet()
                                    ...
                                    ->children()
                                        ->scalarNode('valueDocument')
                                            ->defaultValue('FDT\\MetadataBundle\\Document\\Attributi\\Value\\MisuraValue')
                                        ->end()
                                    ->end()
                                ->end()
                                ->arrayNode('length')
