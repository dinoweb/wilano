                            ...
                            ->children()
                                ...
                                ->addDefaultsIfNotSet()
                                    ...
                                    ->children()
                                        ->scalarNode('formType')
                                            ->cannotBeEmpty()
                                            ->defaultValue('FDT\\MetadataBundle\\Form\\Type\\Attributi\\TextTranslationType')
                                        ->end()
                                    ->end()
                                ->end()
                                ->arrayNode('textarea')
                                ...
                                ->addDefaultsIfNotSet()
                                    ...
                                    ->children()
                                        ->scalarNode('formType')
                                            ->cannotBeEmpty()
                                            ->defaultValue('FDT\\MetadataBundle\\Form\\Type\\Attributi\\TextareaTranslationType')
                                        ->end()
                                    ->end()
                                ->end()
                                ...
                                ->addDefaultsIfNotSet()
                                    ...
                                    ->children()
                                        ->scalarNode('formType')
                                            ->cannotBeEmpty()
                                            ->defaultValue('FDT\\MetadataBundle\\Form\\Type\\Attributi\\TextareaHtmlTranslationType')
                                        ->end()
                                    ->end()
                                ->end()
                                ->arrayNode('number')
